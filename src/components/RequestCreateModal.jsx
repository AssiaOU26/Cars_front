...
function RequestCreateModal({ isOpen, onClose, contacts, onSuccess }) {
  ...
  const parseCustomerInfo = (text) => {
    ...
    return {
      ...
      carModel: lines[1]?.split(" ").slice(0, -1).join(" ") || "",
      carYear: lines[1]?.split(" ").pop() || "",
...
${formData.location}`}
                ...
                required
                rows="4"
                className="w-full bg-white/20 border border-white/30 rounded-lg px-4 py-3 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
...
⚠️ Put each answer on a separate line`}
              ...
              <p className="text-xs text-white/60 mt-2">
                ...
                <strong>Format:</strong> Name on line 1, Car Model & Year on
                line 2, Phone on line 3, Location on line 4
              </p>
            </div>
            ...
            <div className="mt-4">
              ...
              <select
                ...
                className="w-full bg-white/20 border border-white/30 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="border-2 border-dashed border-white/30 rounded-lg p-6 text-center bg-white/5 hover:bg-white/10 transition-colors">
                  <input
                    type="file"
                  ...
                  <label htmlFor="file-upload" className="cursor-pointer">
                    <i className="fas fa-cloud-upload-alt text-3xl text-white/60 mb-2 block"></i>
                    <p className="text-white/80">{t("modal.click_upload")}</p>
          ...
          <div className="flex gap-4 pt-4 border-t border-white/20">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3 px-6 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <>
